    ...
    <div class="container">
	 <jsp:include page="/WEB-INF/views/header.jsp" flush="false"/>
      ...
      <div class="col-xs-12 col-md-10">
		...
		<form id="termscheck" method="post" onsubmit="validate();">
				<div class="article" style="overflow:scroll; width:700px; height:250px; padding=10px;">
...
<br />
					...
					<div id="check">
						...
						<br />
						<input type="button" onclick="validate()" value="다음"/>
					</div>
				</form>
